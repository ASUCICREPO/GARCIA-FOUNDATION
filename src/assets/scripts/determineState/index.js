...
`
let careCoordinatorBar = `<li class="nav-item mT-30 actived">
<a class="sidebar-link" href="careCoordinator_home.html">
  <span class="icon-holder">
    <i class="c-blue-500 fas fa-home"></i>
  </span>
  <span class="title">Home</span>
...
<li class="nav-item mT-30 actived">
<a class='sidebar-link' href="caretaker-careCoordinator.html">
  <span class="icon-holder">
  <i class="c-blue-500 fas fa-hand-holding-medical"></i>
  </span>
  <span class="title">Care Coordinator</span>
...
<li class="nav-item mT-30 actived">
<a class='sidebar-link' href="careCoordinatorChat.html">
  <span class="icon-holder">
    <i class="c-blue-500 fas fa-comments"></i>
  </span>
  <span class="title">Chat</span>
...
<li class="nav-item mT-30 actived">
<a class="sidebar-link" href="invite_careCoordinator.html">
  <span class="icon-holder">
    <i class="c-blue-500 fab fa-telegram-plane"></i>
  </span>
  <span class="title">Send an Invite</span>
...
<li class="nav-item mT-30 actived">
<a class='sidebar-link' href="calendar_careCoordinator.html">
  <span class="icon-holder">
    <i class="c-blue-500 fas fa-calendar-check"></i>
  </span>
  <span class="title">Schedule Appointment</span>
...
let careCoordinator_settings = `<div class="header-container">
<ul class="nav-left">
  <li>
    <a id='sidebar-toggle' class="sidebar-toggle" href="javascript:void(0);">
      <i class="ti-menu"></i>
  ...
  <li class="notifications dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li>
        <ul class="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
          <li>
            <a href="notifications-careCoordinator.html" class='peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100'>
              <div class="peer mR-15">
                <img class="w-3r bdrs-50p" src="https://randomuser.me/api/portraits/lego/5.jpg" alt="">
              </div>
              <div class="peer peer-greed">
      ...
      <li class="pX-20 pY-15 ta-c bdT">
        <span>
          <a href="notifications-careCoordinator.html" class="c-grey-600 cH-blue fsz-sm td-n">View All Notifications <i class="ti-angle-right fsz-xs mL-10"></i></a>
        </span>
      </li>
    </ul>
  </li>
...
if (url.includes('careCoordinator')) {
  document.querySelector('#sideNavBar').innerHTML = careCoordinatorBar
  document.querySelector('#topBar').innerHTML = careCoordinator_settings
